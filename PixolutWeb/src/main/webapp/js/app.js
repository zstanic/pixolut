...
MetronicApp.factory('settings', ['$rootScope', function($rootScope) {
    ...
    var settings = {
        ...
        layoutImgPath: Metronic.getAssetsPath() + 'assets/admin/layout/img/',
        layoutCssPath: Metronic.getAssetsPath() + 'assets/admin/layout/css/'
    };
...
MetronicApp.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state("profile.account", {
            url: "/account",
            templateUrl: "views/profileAccount.html",
        ...
        .state("profile.help", {
            url: "/help",
            templateUrl: "views/profileHelp.html",
